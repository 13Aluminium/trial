# Author: Ayush Luhar, Jash Karangiya, and Krishnan Pandya
...
from tkinter import (Button, Canvas, Entry, Frame, PhotoImage, Scrollbar, Text, Label,
...
def display_table(df):
    ...
    title_label = Label(table_frame, text="Sales Transactions", font=('Arial', 16, 'bold'), bg="#FFFFFF")
